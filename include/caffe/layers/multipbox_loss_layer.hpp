#ifndef CAFFE_MULTIPBOX_LOSS_LAYER_HPP_
#define CAFFE_MULTIPBOX_LOSS_LAYER_HPP_
...
namespace caffe {
	...
	/**
	* @brief Perform MultiPBox operations. Including the following:
	*
	...
	*/
	...
	class MultiPBoxLossLayer : public LossLayer<Dtype> {
	public:
		explicit MultiPBoxLossLayer(const LayerParameter& param)
		...
		virtual inline const char* type() const { return "MultiPBoxLoss"; }
	...
	protected:
		...
		MultiPBoxLossParameter multipbox_loss_param_;
		int num_classes_;
		bool share_location_;
		PMatchType match_type_;
		...
		float neg_overlap_;
		PCodeType code_type_;
		bool encode_variance_in_target_;
		bool map_object_to_agnostic_;
		bool ignore_cross_boundary_pbox_;
		bool bp_inside_;
		PMiningType mining_type_;
...
#endif  // CAFFE_MULTIPBOX_LOSS_LAYER_HPP_
