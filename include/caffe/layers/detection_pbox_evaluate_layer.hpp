#ifndef CAFFE_DETECTION_PBOX_EVALUATE_LAYER_HPP_
#define CAFFE_DETECTION_PBOX_EVALUATE_LAYER_HPP_
...
class DetectionPboxEvaluateLayer : public Layer<Dtype> {
 public:
  explicit DetectionPboxEvaluateLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "DetectionPboxEvaluate"; }
...
#endif  // CAFFE_DETECTION_PBOX_EVALUATE_LAYER_HPP_
