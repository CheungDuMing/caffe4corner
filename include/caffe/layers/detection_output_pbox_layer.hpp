#ifndef CAFFE_DETECTION_OUTPUT_PBOX_LAYER_HPP_
#define CAFFE_DETECTION_OUTPUT_PBOX_LAYER_HPP_
...
namespace caffe {
	...
	*
	* Intended for use with MultiPBox detection method.
	*
	* NOTE: does not implement Backwards operation.
	*/
	template <typename Dtype>
	class DetectionOutputPboxLayer : public Layer<Dtype> {
	public:
		explicit DetectionOutputPboxLayer(const LayerParameter& param)
			: Layer<Dtype>(param) {}
		...
		virtual inline const char* type() const { return "DetectionOutputPbox"; }
	...
	protected:
		...
		*      the prior bounding pboxes with C3 values.
		...
		*/
		...
		string save_file_;
		Blob<Dtype> pbox_preds_;
		Blob<Dtype> pbox_permute_;
...
#endif  // CAFFE_DETECTION_OUTPUT_PBOX_LAYER_HPP_
