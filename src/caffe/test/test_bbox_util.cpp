...
//************************************************************************
void FillPBoxes(vector<NormalizedPBox>* gt_pboxes,
	vector<NormalizedPBox>* pred_pboxes) {
	gt_pboxes->clear();
	pred_pboxes->clear();
	NormalizedPBox pbox;
	...
	pbox.set_ltopx(0.1);
	pbox.set_ltopy(0.1);
	pbox.set_lbottomx(0.1);
	pbox.set_lbottomy(0.3);
	pbox.set_rbottomx(0.3);
	pbox.set_rbottomy(0.3);
	pbox.set_rtopx(0.3);
	pbox.set_rtopy(0.1);
	gt_pboxes->push_back(pbox);
	...
	pbox.set_ltopx(0.3);
	pbox.set_ltopy(0.3);
	pbox.set_lbottomx(0.3);
	pbox.set_lbottomy(0.5);
	pbox.set_rbottomx(0.6);
	pbox.set_rbottomy(0.5);
	pbox.set_rtopx(0.6);
	pbox.set_rtopy(0.3);
	gt_pboxes->push_back(pbox);
	...
	pbox.set_lbottomx(0.1);
	pbox.set_lbottomy(0.3);
	pbox.set_rbottomx(0.4);
	pbox.set_rbottomy(0.3);
	pbox.set_rtopx(0.4);
	pbox.set_rtopy(0);
	pred_pboxes->push_back(pbox);
	...
	pbox.set_ltopx(0.2);
	pbox.set_ltopy(0.1);
	pbox.set_lbottomx(0.2);
	pbox.set_lbottomy(0.4);
	pbox.set_rbottomx(0.4);
	pbox.set_rbottomy(0.4);
	pbox.set_rtopx(0.4);
	pbox.set_rtopy(0.1);
	pred_pboxes->push_back(pbox);
	...
	pbox.set_ltopx(0.4);
	pbox.set_ltopy(0.3);
	pbox.set_lbottomx(0.4);
	pbox.set_lbottomy(0.5);
	pbox.set_rbottomx(0.7);
	pbox.set_rbottomy(0.5);
	pbox.set_rtopx(0.7);
	pbox.set_rtopy(0.3);
	pred_pboxes->push_back(pbox);
	...
	pbox.set_ltopx(0.5);
	pbox.set_ltopy(0.4);
	pbox.set_lbottomx(0.5);
	pbox.set_lbottomy(0.7);
	pbox.set_rbottomx(0.7);
	pbox.set_rbottomy(0.7);
	pbox.set_rtopx(0.7);
	pbox.set_rtopy(0.4);
	pred_pboxes->push_back(pbox);
	...
	pbox.set_ltopx(0.7);
	pbox.set_ltopy(0.7);
	pbox.set_lbottomx(0.7);
	pbox.set_lbottomy(0.8);
	pbox.set_rbottomx(0.8);
	pbox.set_rbottomy(0.8);
	pbox.set_rtopx(0.8);
	pbox.set_rtopy(0.7);
	pred_pboxes->push_back(pbox);
}
...
template <typename TypeParam>
class PBoxUtilTest : public MultiDeviceTest<TypeParam> {
	typedef typename TypeParam::Dtype Dtype;
};

class CPUPBoxUtilTest : public PBoxUtilTest<CPUDevice<float> > {
};
//!!!!!!! There is no function named IntersectPbox !!!!!
TEST_F(CPUPBoxUtilTest, TestIntersectPBox) {
	NormalizedPBox pbox_ref;
	/*bbox_ref.set_xmin(0.2);
	bbox_ref.set_ymin(0.3);
	bbox_ref.set_xmax(0.3);
	bbox_ref.set_ymax(0.5);*/
	pbox_ref.set_ltopx(0.2);
	pbox_ref.set_ltopy(0.3);
	pbox_ref.set_lbottomx(0.2);
	pbox_ref.set_lbottomy(0.5);
	pbox_ref.set_rbottomx(0.3);
	pbox_ref.set_rbottomy(0.5);
	pbox_ref.set_rtopx(0.3);
	pbox_ref.set_rtopy(0.3);

	NormalizedPBox pbox_test;
	NormalizedPBox pbox_intersect;
	...
	//bbox_test.set_xmax(0.3);
	//bbox_test.set_ymax(0.4);
	pbox_test.set_ltopx(0.1);
	pbox_test.set_ltopy(0.1);
	pbox_test.set_lbottomx(0.1);
	pbox_test.set_lbottomy(0.4);
	pbox_test.set_rbottomx(0.3);
	pbox_test.set_rbottomy(0.4);
	pbox_test.set_rtopx(0.3);
	pbox_test.set_rtopy(0.1);

	IntersectPBox(pbox_ref, pbox_test, &pbox_intersect);
	/*EXPECT_NEAR(pbox_intersect.xmin(), 0.2, eps);
	EXPECT_NEAR(pbox_intersect.ymin(), 0.3, eps);
	EXPECT_NEAR(pbox_intersect.xmax(), 0.3, eps);
	EXPECT_NEAR(pbox_intersect.ymax(), 0.4, eps);*/
	EXPECT_NEAR(pbox_intersect.ltopx(), 0.2, eps);
	EXPECT_NEAR(pbox_intersect.ltopy(), 0.3, eps);
	EXPECT_NEAR(pbox_intersect.lbottomx(), 0.2, eps);
	EXPECT_NEAR(pbox_intersect.lbottomy(), 0.4, eps);
	EXPECT_NEAR(pbox_intersect.rbottomx(), 0.3, eps);
	EXPECT_NEAR(pbox_intersect.rbottomy(), 0.4, eps);
	EXPECT_NEAR(pbox_intersect.rtopx(), 0.3, eps);
	EXPECT_NEAR(pbox_intersect.rtopy(), 0.3, eps);
	...
	pbox_test.set_ltopy(0.1);
	pbox_test.set_lbottomx(0.1);
	pbox_test.set_lbottomy(0.6);
	pbox_test.set_rbottomx(0.4);
	pbox_test.set_rbottomy(0.6);
	pbox_test.set_rtopx(0.4);
	pbox_test.set_rtopy(0.1);
	IntersectPBox(pbox_ref, pbox_test, &pbox_intersect);
	EXPECT_NEAR(pbox_intersect.ltopx(), 0.2, eps);
	EXPECT_NEAR(pbox_intersect.ltopy(), 0.3, eps);
	EXPECT_NEAR(pbox_intersect.lbottomx(), 0.2, eps);
	EXPECT_NEAR(pbox_intersect.lbottomy(), 0.5, eps);
	EXPECT_NEAR(pbox_intersect.rbottomx(), 0.3, eps);
	EXPECT_NEAR(pbox_intersect.rbottomy(), 0.5, eps);
	EXPECT_NEAR(pbox_intersect.rtopx(), 0.3, eps);
	EXPECT_NEAR(pbox_intersect.rtopy(), 0.3, eps);
	//EXPECT_NEAR(bbox_intersect.xmin(), 0.2, eps);
	//EXPECT_NEAR(bbox_intersect.ymin(), 0.3, eps);
	...
	//bbox_test.set_xmax(0.1);
	//bbox_test.set_ymax(0.1);
	pbox_test.set_ltopx(0);
	pbox_test.set_ltopy(0);
	pbox_test.set_lbottomx(0);
	pbox_test.set_lbottomy(0.1);
	pbox_test.set_rbottomx(0.1);
	pbox_test.set_rbottomy(0.1);
	pbox_test.set_rtopx(0.1);
	pbox_test.set_rtopy(0);
	IntersectPBox(pbox_ref, pbox_test, &pbox_intersect);

	EXPECT_NEAR(pbox_intersect.ltopx(), 0, eps);
	EXPECT_NEAR(pbox_intersect.ltopy(), 0, eps);
	EXPECT_NEAR(pbox_intersect.lbottomx(), 0, eps);
	EXPECT_NEAR(pbox_intersect.lbottomy(), 0, eps);
	EXPECT_NEAR(pbox_intersect.rbottomx(), 0, eps);
	EXPECT_NEAR(pbox_intersect.rbottomy(), 0, eps);
	EXPECT_NEAR(pbox_intersect.rtopx(), 0, eps);
	EXPECT_NEAR(pbox_intersect.rtopy(), 0, eps);
	/*EXPECT_NEAR(bbox_intersect.xmin(), 0, eps);
	EXPECT_NEAR(bbox_intersect.ymin(), 0, eps);
	EXPECT_NEAR(bbox_intersect.xmax(), 0, eps);
	EXPECT_NEAR(bbox_intersect.ymax(), 0, eps);*/
...
TEST_F(CPUPBoxUtilTest, TestPBoxSize) {
	NormalizedPBox pbox;
	float size;
...
TEST_F(CPUPBoxUtilTest, TestScalePBox) {
	NormalizedPBox pbox;
	pbox.set_ltopx(0.21);
	pbox.set_ltopy(0.32);
	pbox.set_lbottomx(0.21);
	pbox.set_lbottomy(0.54);
	pbox.set_rbottomx(0.33);
	pbox.set_rbottomy(0.54);
	pbox.set_rtopx(0.33);
	pbox.set_rtopy(0.32);
	...
	int height = 10;
	int width = 20;
	ScalePBox(pbox, height, width, &scale_pbox);
	EXPECT_NEAR(scale_pbox.ltopx(), 4.2, eps);
	EXPECT_NEAR(scale_pbox.ltopy(), 3.2, eps);
	EXPECT_NEAR(scale_pbox.lbottomx(), 4.2, eps);
	EXPECT_NEAR(scale_pbox.lbottomy(), 5.4, eps);
	EXPECT_NEAR(scale_pbox.rbottomx(), 6.6, eps);
	EXPECT_NEAR(scale_pbox.rbottomy(), 5.4, eps);
	EXPECT_NEAR(scale_pbox.rtopx(), 6.6, eps);
	EXPECT_NEAR(scale_pbox.rtopy(), 3.2, eps);
	/*EXPECT_NEAR(scale_bbox.xmin(), 4.2, eps);
	EXPECT_NEAR(scale_bbox.ymin(), 3.2, eps);
	EXPECT_NEAR(scale_bbox.xmax(), 6.6, eps);
	EXPECT_NEAR(scale_bbox.ymax(), 5.4, eps);*/
	EXPECT_NEAR(scale_pbox.size(), 10.88, eps);

	height = 1;
	width = 1;
	ScalePBox(pbox, height, width, &scale_pbox);
	EXPECT_NEAR(scale_pbox.ltopx(), pbox.ltopx(), eps);
	EXPECT_NEAR(scale_pbox.ltopy(), pbox.ltopy(), eps);
	EXPECT_NEAR(scale_pbox.lbottomx(), pbox.lbottomx(), eps);
	EXPECT_NEAR(scale_pbox.lbottomy(), pbox.lbottomy(), eps);
	EXPECT_NEAR(scale_pbox.rbottomx(), pbox.rbottomx(), eps);
	EXPECT_NEAR(scale_pbox.rbottomy(), pbox.rbottomy(), eps);
	EXPECT_NEAR(scale_pbox.rtopx(), pbox.rtopx(), eps);
	EXPECT_NEAR(scale_pbox.rtopy(), pbox.rtopy(), eps);

	/*EXPECT_NEAR(bbox.xmin(), scale_bbox.xmin(), eps);
	EXPECT_NEAR(bbox.ymin(), scale_bbox.ymin(), eps);
	EXPECT_NEAR(bbox.xmax(), scale_bbox.xmax(), eps);
	EXPECT_NEAR(bbox.ymax(), scale_bbox.ymax(), eps);*/
	EXPECT_NEAR(scale_pbox.size(), 0.0264, eps);
}

TEST_F(CPUPBoxUtilTest, TestClipPBox) {
	NormalizedPBox pbox;
	...
	//bbox.set_xmax(0.3);
	//bbox.set_ymax(0.5);
	ClipPBox(pbox, &clip_pbox);
	EXPECT_NEAR(clip_pbox.ltopx(), pbox.ltopx(), eps);
	EXPECT_NEAR(clip_pbox.ltopy(), pbox.ltopy(), eps);
	EXPECT_NEAR(clip_pbox.lbottomx(), pbox.lbottomx(), eps);
	EXPECT_NEAR(clip_pbox.lbottomy(), pbox.lbottomy(), eps);
	EXPECT_NEAR(clip_pbox.rbottomx(), pbox.rbottomx(), eps);
	EXPECT_NEAR(clip_pbox.rbottomy(), pbox.rbottomy(), eps);
	EXPECT_NEAR(clip_pbox.rtopx(), pbox.rtopx(), eps);
	EXPECT_NEAR(clip_pbox.rtopy(), pbox.rtopy(), eps);

	/*EXPECT_NEAR(bbox.xmin(), clip_bbox.xmin(), eps);
	EXPECT_NEAR(bbox.ymin(), clip_bbox.ymin(), eps);
	EXPECT_NEAR(bbox.xmax(), clip_bbox.xmax(), eps);
	EXPECT_NEAR(bbox.ymax(), clip_bbox.ymax(), eps);*/
	EXPECT_NEAR(clip_pbox.size(), 0.02, eps);

	pbox.set_ltopx(-0.2);
	pbox.set_ltopy(-0.3);
	pbox.set_lbottomx(-0.2);
	pbox.set_lbottomy(1.5);
	pbox.set_rbottomx(1.3);
	pbox.set_rbottomy(1.5);
	pbox.set_rtopx(1.3);
	pbox.set_rtopy(-0.3);
	...
	bbox.set_ymax(1.5);*/
	ClipPBox(pbox, &clip_pbox);
	EXPECT_NEAR(clip_pbox.ltopx(), 0, eps);
	EXPECT_NEAR(clip_pbox.ltopy(), 0, eps);
	EXPECT_NEAR(clip_pbox.lbottomx(), 0, eps);
	EXPECT_NEAR(clip_pbox.lbottomy(), 1, eps);
	EXPECT_NEAR(clip_pbox.rbottomx(), 1), eps);
	EXPECT_NEAR(clip_pbox.rbottomy(), 1, eps);
	EXPECT_NEAR(clip_pbox.rtopx(), 1, eps);
	EXPECT_NEAR(clip_pbox.rtopy(), 0, eps);
	EXPECT_NEAR(clip_pbox.size(), 1., eps);
...
TEST_F(CPUPBoxUtilTest, TestOutputPBox) {
	NormalizedPBox pbox;
	...
	OutputPBox(pbox, img_size, has_resize, resize_param, &out_pbox);
	CHECK_EQ(out_pbox.ltopx(), 0.);
	CHECK_EQ(out_pbox.ltopy(), 90.);
	CHECK_EQ(out_pbox.lbottomx(), 0.);
	CHECK_EQ(out_pbox.lbottomy(), 150.);
	CHECK_EQ(out_pbox.rbottomx(), 150.);
	CHECK_EQ(out_pbox.rbottomy(), 150.);
	CHECK_EQ(out_pbox.rtopx(), 150.);
	CHECK_EQ(out_pbox.rtopy(), 90.);
	...
	//***************************************************************
	//need to change the function OutputPBox(args)
