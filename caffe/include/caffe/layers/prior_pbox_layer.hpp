#ifndef CAFFE_PRIORPBOX_LAYER_HPP_
#define CAFFE_PRIORPBOX_LAYER_HPP_
...
namespace caffe {
	...
	*/
	...
	class PriorPBoxLayer : public Layer<Dtype> {
	public:
		/**
		...
		*/
		explicit PriorPBoxLayer(const LayerParameter& param)
			: Layer<Dtype>(param) {}
		...
		virtual inline const char* type() const { return "PriorPBox"; }
...
#endif  // CAFFE_PRIORPBOX_LAYER_HPP_
