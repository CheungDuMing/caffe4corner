...
caffe_root = home + '/newcaffe/caffe'
...
lr_mult = 1.
# Stores LabelMapItem.
label_map_file = home + "/huawei-ssd/huaweiimages/labelmap.prototxt"
...
save_dir = home + "/huawei-ssd/huaweiimages/models/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = home + "/huawei-ssd/huaweiimages"
# Directory which stores the job script and log file.
job_dir = home + "/huawei-ssd/huaweiimages/jobs/{}".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/huawei-ssd/huaweiimages/results/{}".format(os.environ['HOME'], job_name)
...
# Stores LabelMapItem.
label_map_file = home + "/huawei-ssd/huaweiimages/labelmap.prototxt"
test_data = home + "/huawei-ssd/huaweiimages/lmdb/test_lmdb"
...
# Create test net.
net = caffe.NetSpec()
#net.data = L.Data(source=images_data,
 #       data_param=dict(batch_size=test_batch_size),
  #      transform_param=test_transform_param,
   #     backend=1,force_encoded_color=True)
